...
public class SemController {
	...
	public ResponseEntity<?> addSem(@RequestBody SemDTO semDTO) {
		...
		return new ResponseEntity<>(semService.addSem(semDTO),HttpStatus.CREATED);

	}

	@PutMapping("/updateSemName/{id}")
	public ResponseEntity<?> updateSem(@PathVariable("id") int id,@RequestBody SemDTO semDTO) {
		
		return new ResponseEntity<>(semService.updateSem(id, semDTO),HttpStatus.OK);
	...
	public ResponseEntity<?> deleteSem(@PathVariable("id") int id, @RequestBody SemDTO semDTO) {
		...
		return new ResponseEntity<>(semService.delteSemById(id, semDTO),HttpStatus.OK);
	...
	public ResponseEntity<?> deleteAllSem(@RequestBody SemDTO semDTO) {
		...
		return new ResponseEntity<>(semService.deleteAllSem(semDTO),HttpStatus.OK);
