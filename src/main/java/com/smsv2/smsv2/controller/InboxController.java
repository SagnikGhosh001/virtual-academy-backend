...
public class InboxController {
	...
	public ResponseEntity<?> addinbox(@RequestBody InboxDTO inboxDTO) {
			return new ResponseEntity<>(inboxService.addInbox(inboxDTO),HttpStatus.CREATED);
	...
	public ResponseEntity<?> updateinbox(@RequestBody InboxDTO inboxDTO, @PathVariable("id") int id) {
		...
		return new ResponseEntity<>(inboxService.updateInbox(id, inboxDTO),HttpStatus.OK);

	}
	@PutMapping("/isread/{id}")
	public ResponseEntity<?> isread(@RequestBody InboxDTO inboxDTO, @PathVariable("id") int id) {
		
		return new ResponseEntity<>(inboxService.isRead(id, inboxDTO),HttpStatus.OK);
	...
	public ResponseEntity<?> deleteinbox(@RequestBody InboxDTO inboxDTO, @PathVariable("id") int id) {
		...
		return new ResponseEntity<>(inboxService.delteInboxById(id, inboxDTO),HttpStatus.OK);
	...
	public ResponseEntity<?> deleteAllinbox(@RequestBody InboxDTO inboxDTO) {
		...
		return new ResponseEntity<>(inboxService.deleteAllInbox(inboxDTO),HttpStatus.OK);
