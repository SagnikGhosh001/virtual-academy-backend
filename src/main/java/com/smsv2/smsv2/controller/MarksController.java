...
public class MarksController {
	...
	@GetMapping("/marksByStudentId/{id}")
	public ResponseEntity<?> marksByStudentId(@PathVariable("id") int id) {
		return new ResponseEntity<>(marksservice.getAllMarksByStudentId(id), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> addmarks(@RequestBody MarksDTO marksDTO) {
		...
		return new ResponseEntity<>(marksservice.addMarks(marksDTO),HttpStatus.CREATED);
	}

	@PutMapping("/updatemarks/{id}")
	public ResponseEntity<?> updatemarks(@RequestBody MarksDTO marksDTO, @PathVariable int id) {
		
		return new ResponseEntity<>(marksservice.updateMarkbyId(id, marksDTO),HttpStatus.OK);
	...
	public ResponseEntity<?> deletemarks(@PathVariable int id, @RequestBody MarksDTO marksDTO) {
		...
		return new ResponseEntity<>(marksservice.delteMarksById(id, marksDTO),HttpStatus.OK);
	...
	public ResponseEntity<?> deleteAllmarks(@RequestBody MarksDTO marksDTO) {
		...
		return new ResponseEntity<>(marksservice.deleteAllMarks(marksDTO),HttpStatus.OK);
